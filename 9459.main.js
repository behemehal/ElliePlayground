...
/* harmony import */ var _pkg_index_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_pkg_index_js__WEBPACK_IMPORTED_MODULE_0__);
...
onmessage = ({ data: { cmd, code } }) => {
  if (cmd === "run") {
    ...
    try {
      (0,_pkg_index_js__WEBPACK_IMPORTED_MODULE_0__.run)(
        (e) => {
          try {
